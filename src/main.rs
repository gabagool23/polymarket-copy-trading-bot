    ...
    match result {
        Ok(post_order_resp) => {
            ...
            let mut base = format!(
                ...
                status_str, size_type_str, fill_color, filled_shares, my_shares, reset, pink, actual_fill_price, reset, whale_color, whale_shares, reset, whale_price
            );
                ...
                if error_str.contains("Insufficient balance/allowance") || 
                   ...
                   error_str.contains("allowance") {
                    println!(
                        ...
                        attempt, fill_color, req.cumulative_filled, req.original_size, fill_pct, reset, error_str
                    );
                    return;
                }
